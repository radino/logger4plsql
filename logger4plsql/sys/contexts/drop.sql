...
drop context ctx_logger_modify_session_g;
...
drop context ctx_logger_params_l;

rem Contexts for appenders
drop context ctx_logger_dbms_out_app_g;
drop context ctx_logger_dbms_out_app_l;
drop context ctx_logger_smtp_app_g;
drop context ctx_logger_smtp_app_l;
drop context ctx_logger_table_app_g;
drop context ctx_logger_table_app_l;
